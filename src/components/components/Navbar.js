            ...
            <div>
                <nav className="navbar">
                    <div className="container">
                        <NavLink to="/" className="navbar-brand"><img src={Logo} alt="CSSA @ UCSD"></img> </NavLink>
                        <div className="menu">
                            <ul className="nav">
                                ...
                                <li className='nav-item'>
                                    <NavLink to='/involvement' className='nav-link' activeClassName='active'>Involvement</NavLink>
                                </li>
                                <li className='nav-item'>
